...
> set JDK_HOME=C:\Program Files (x86)\Java\jdk1.7.0_06

set the environment variable JAVAFX_SDK_HOME to the location of your JavaFX 2.2 SDK install, for example:
